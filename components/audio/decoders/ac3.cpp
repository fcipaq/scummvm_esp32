...
AC3Stream::AC3Stream(float decibel) : _a52State(0), _frameSize(0), _inBufPtr(0), _flags(0), _sampleRate(0) {
...
PacketizedAudioStream *makeAC3Stream(Common::SeekableReadStream &firstPacket, float decibel) {
